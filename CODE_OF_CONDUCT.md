...
Because this is a genealogy project, one point deserves emphasis: **records about real people,
living or dead, are not example data.** Do not attach, paste, or commit real family data —
names, dates, places, photographs, or documents — to issues, pull requests, or discussions. Use
the synthetic generator (`npm run generate:synthetic-data`) for anything you need to share.
Living people's details posted without consent will be removed.
...
maintainer, [@dylanwebster](https://github.com/dylanwebster), by direct message on GitHub. All
