...
function PlaceSearchCombobox({ value, onChange, onSelect, initialPlace }: { value: string; onChange: (name: string) => void; onSelect?: (place: Place) => void; initialPlace?: Place | null }) {
    return (
